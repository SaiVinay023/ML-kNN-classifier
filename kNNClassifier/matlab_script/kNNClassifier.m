...
%plot bar graph to check error rate 
figure 
...
%% Task 3 : Test kNN classifier
%Compute accurancy on the test set (10 tasks: each digit vs the
%remaining 9, and for several values of k) 
 ...
 %in this case, considering just a single digit, classification can be
 %just 0 or 1. 
...
%Plot accuravy wrt Kappa values
...
%Plotting accuracy of each digit wrt K
% figure; hold on;
...
%Accuracy bar graph of each digit wrt K
for i = 1: size(accuracy,2) 
    figure; 
